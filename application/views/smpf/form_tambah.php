...
//dependent  kabupaten
  ...
  $("#kec").change(function(){
  ...
  </script><form method="post" action="<?php echo site_url('Smpf/tambah') ?>">
    ...
    <tr>      
      <td><input type="text" name="jumlahUptL" class="form-control"></td>
      <td><input type="text" name="jumlahUptP" class="form-control"></td>
      <td><input type="text" name="jumlahNUptL" class="form-control"></td>      
      <td><input type="text" name="jumlahNUptP" class="form-control"></td>
    </tr>
    <tr>
      ...
      <td colspan="4">
        <select name="lokasi" class="form-control">
            ...
            <option value="0">Di Dalam UPT</option>
            <option value="1">Di Luar UPT</option>
        </select>
      </td>
    </tr>    
		<tr>      
