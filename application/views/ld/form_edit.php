...
//dependent  kabupaten
  ...
  </script><form method="post" action="<?php echo site_url('ld/edit') ?>">
  ...
  foreach ($viewData as $view) {
    ?>
		...
		<tr>
			...
			<td colspan="5">
        <input type="hidden" value="<?php echo $view->kd_ld ?>" name="kd">
        <input type="hidden" value="<?php echo $view->kd_desa ?>" name="kdes">
          ...
          <option value="0" <?php if($view->ld == 0){echo "selected=''";} ?>>Rukun Warga / RW</option>
          <option value="1" <?php if($view->ld == 1){echo "selected=''";} ?>>Rukun Tetangga / RT</option>
          <option value="2" <?php if($view->ld == 2){echo "selected=''";} ?>>Kelompencapir</option>
          <option value="3" <?php if($view->ld == 3){echo "selected=''";} ?>>Siskamling / SRD</option>
          <option value="4" <?php if($view->ld == 4){echo "selected=''";} ?>>Musyawarah Warga</option>
          <option value="5" <?php if($view->ld == 5){echo "selected=''";} ?>>Kelompok Tani</option>
          <option value="6" <?php if($view->ld == 6){echo "selected=''";} ?>>Kelompok Usaha Bersama</option>
          <option value="7" <?php if($view->ld == 7){echo "selected=''";} ?>>Karang Taruna</option>
          <option value="8" <?php if($view->ld == 8){echo "selected=''";} ?>>Gapoktan</option>
        </select>
			</td>
		</tr>
    ...
    <tr>
      <td><input type="text" name="unit" class="form-control" value="<?php echo $view->unit ?>"></td>
      <td><input type="text" name="pengurusL" class="form-control" value="<?php echo $view->pengurusL ?>"></td>
      <td><input type="text" name="pengurusP" class="form-control" value="<?php echo $view->pengurusP ?>"></td>
      <td><input type="text" name="anggotaL" class="form-control" value="<?php echo $view->anggotaL ?>"></td>
      <td><input type="text" name="anggotaP" class="form-control" value="<?php echo $view->anggotaP ?>"></td>
    </tr>    
    <tr>
