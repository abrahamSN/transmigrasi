...
<!-- Page Heading -->
                ...
                <div class="row">                                        
                            <a style="margin-bottom:5px" class="btn btn-primary btn-sm" href="<?php echo site_url('jtak/form_tambah') ?>"><i class="fa fa-sm fa-plus"></i> Tambah Data</a>                                    
                        <h1>
                            Jumlah Tenaga Medis Dan Aktivitas Kunjungan
                        </h1> 
                        <div class="well">

                        <form class="form-horizontal" method="get" action="<?php echo site_url("jtak/");?>" role="form">
                ...
                <!-- /.row -->                                
                            ...
                            <table class="table table-hover table-bordered">                                
                                <tr>
                                    <th rowspan="2">Jenis Tenaga Medis</th>                                    
                                    <th colspan="3" class="text-center">Jumlah Tenaga Medis</th>                                    
                                ...
                                foreach ($viewData as $view) {                                  
                                  ...
                                  <tr>
                                    ...
                                    <td>
                                      <?php echo $view->tmL + $view->tmP; ?>
                                    </td>               
                                    <td>
                                      <?php 
                                      if($view->ttinggal==0){echo "Di Lokasi";}else{echo "Di Luar Lokasi";}  ?>
                                    </td>
                                    <td>
                                      <?php echo $view->kunjungan; ?>
                                    </td>
                                    <td>
                                      <a href="<?php echo site_url('jtak/form_edit/'.$view->kd_jtak) ?>">Edit</a>
                                      <a href="<?php echo site_url('jtak/hapus/'.$view->kd_jtak) ?>" onclick="return confirm('Yakin Akan Hapus Data ?')">Hapus</a>
                                    </td>
                                	</tr>
                                	<?php
                                }
