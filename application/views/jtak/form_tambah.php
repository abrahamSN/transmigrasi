...
//dependent  kabupaten
  ...
  $("#kec").change(function(){
  ...
  </script><form method="post" action="<?php echo site_url('jtak/tambah') ?>">
	...
	<table class="table">
		...
		<tr>
			...
			<td colspan="2">
				<input type="text" name="jenistm" class="form-control">
			</td>
		</tr>
    ...
    <tr>
      ...
      <td>
		...
		<tr>			      
      <td><input type="text" name="tmL" class="form-control"></td>
    ...
    <tr>
      ...
      <td colspan="2">
        <select name="ttinggal" class="form-control">
          ...
          <option value="0">Di Lokasi</option>
          <option value="1">Di Luar Lokasi</option>
        </select>
      </td>      
    </tr>  
    <tr>
