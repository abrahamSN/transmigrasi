...
//dependent  kabupaten
  ...
  </script><form method="post" action="<?php echo site_url('Pussd/tambah') ?>">
	<h3>Form Penduduk Usia Sekolah Yang Sedang Bersekolah</h3>
	<table class="table">
  <?php 
  foreach ($viewData as $view) {
    ?>
		...
		<tr>
			...
			<td colspan="3">
        <input type="hidden" value="<?php echo $view->kd_pussd ?>" name="kd">
				<select name="usia" class="form-control" required="">
            <option selected="" disabled="">-- Pilih Rentang Usia --</option>
            <option value="0" <?php if($view->usia == "0"){echo "selected=''";} ?>>TK (4-6 Tahun)</option>
            <option value="1" <?php if($view->usia == "1"){echo "selected=''";} ?>>SD (7-12 Tahun)</option>
            <option value="2" <?php if($view->usia == "2"){echo "selected=''";} ?>>SLTP (14-15 Tahun)</option>
            <option value="3" <?php if($view->usia == "3"){echo "selected=''";} ?>>TK (16-18 Tahun)</option>
        </select>
			</td>
		</tr>
		<tr>			
    ...
    <tr>
      <td>
        <input type="text" name="l" class="form-control" value="<?php echo $view->l ?>">
      </td>    
      <td>
        <input type="text" name="p" class="form-control" value="<?php echo $view->p ?>">
      </td>
    </tr>
    <?php
  }
