...
<h2>Form Input Kondisi Prasarana Transportasi</h2>
<form method="post" action="<?php echo site_url('FasilitasKehidupan/tambahKpt') ?>">
	<table class="table">
		<tr>
			<td>Desa</td>
			<td colspan="2">
		...
		<tr>
			...
			<td colspan="2"><input type="text" name="jenisp" class="form-control"></td>
		</tr>
		<tr>
			<td>Jumlah</td>
			<td colspan="2"><input type="text" name="jumlah" class="form-control"></td>
		</tr>
		<tr>
		...
		<tr>
			<td><input type="text" name="rusak" class="form-control"></td>
			<td><input type="text" name="rusakb" class="form-control"></td>
		</tr>
		<tr>
			<td colspan="3" class="text-right">
				<button type="submit" class="btn btn-primary btn-sm">
					<i class="fa fa-sm fa-check"></i> Simpan Data
				</button>
			</td>
		</tr>
