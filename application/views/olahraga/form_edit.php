...
//dependent  kabupaten
  ...
  </script><form method="post" action="<?php echo site_url('olahraga/edit') ?>">
	<h3>Form Olahraga </h3>
	<table class="table">
  <?php 
  ...
  ?>
		...
		<tr>
			...
			<td colspan="2">
        <input type="hidden" value="<?php echo $view->kd_or ?>" name="kd">
        <input type="hidden" value="<?php echo $view->kd_desa ?>" name="kdes">
          ...
          <option value="0" <?php if($view->olahraga == 0){echo "selected=''";} ?>>Sepak Bola</option>
          <option value="1" <?php if($view->olahraga == 1){echo "selected=''";} ?>>Bola Volley</option>
          <option value="2" <?php if($view->olahraga == 2){echo "selected=''";} ?>>Tenis Meja</option>
          <option value="3" <?php if($view->olahraga == 3){echo "selected=''";} ?>>Bulu Tangkis</option>
          <option value="4" <?php if($view->olahraga == 4){echo "selected=''";} ?>>Sepak Takraw</option>
          <option value="5" <?php if($view->olahraga == 5){echo "selected=''";} ?>>Pencak Silat</option>          
        </select>
			</td>
		</tr>
