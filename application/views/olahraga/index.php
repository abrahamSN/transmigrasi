...
<!-- Page Heading -->
                ...
                <div class="row">                                        
                            <a style="margin-bottom:5px" class="btn btn-primary btn-sm" href="<?php echo site_url('olahraga/form_tambah') ?>"><i class="fa fa-sm fa-plus"></i> Tambah Data</a>                                    
                        <h1>
                            Olahraga
                        </h1> 
                        <div class="well">

                        <form class="form-horizontal" method="get" action="<?php echo site_url("olahraga/");?>" role="form">
                            ...
                            <table class="table table-hover table-bordered">                                
                                ...
                                foreach ($viewData as $view) {                                  
                                  ...
                                  <tr>
                                    <td>
                                      <?php 
                                      if($view->olahraga == 0){echo "Sepak Bola";}
                                      else if($view->olahraga == 1){echo "Bola Volley";} 
                                      else if($view->olahraga == 2){echo "Tenis Meja";}
                                      else if($view->olahraga == 3){echo "Bulu Tangkis";}
                                      else if($view->olahraga == 4){echo "Sepak Takraw";}                                    
                                      else{echo "Pencak Silat";}
                                      ?>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                      <a href="<?php echo site_url('olahraga/form_edit/'.$view->kd_or) ?>">Edit</a>
                                      <a href="<?php echo site_url('olahraga/hapus/'.$view->kd_or) ?>" onclick="return confirm('Yakin Akan Hapus Data ?')">Hapus</a>
                                    </td>
                                	</tr>
                                	<?php
                                }
