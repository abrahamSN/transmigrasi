...
<!-- Page Heading -->
                ...
                <div class="row">                                        
                            <a style="margin-bottom:5px" class="btn btn-primary btn-sm" href="<?php echo site_url('kAgama/form_tambah') ?>"><i class="fa fa-sm fa-plus"></i> Tambah Data</a>                                    
                        <h1>
                            Kegiatan Keagamaan
                        </h1> 
                        <div class="well">

                        <form class="form-horizontal" method="get" action="<?php echo site_url("kAgama/");?>" role="form">
                ...
                <!-- /.row -->                                
                            ...
                            <table class="table table-hover table-bordered">                                
                                <tr>
                                    <th>Kegiatan</th>                                    
                                    <th>Frekuensi Kegiatan Per Tahun (Kali)</th>                                    
                                    <th>Aksi</th>
                                </tr>
                                <?php 
                                foreach ($viewData as $view) {                                  
                                  ...
                                  <tr>
                                    ...
                                    <td>
                                      <?php echo $view->frekuensi ?>
                                    </td>
                                    <td>
                                      <a href="<?php echo site_url('kAgama/form_edit/'.$view->kd_ka) ?>">Edit</a>
                                      <a href="<?php echo site_url('kAgama/hapus/'.$view->kd_ka) ?>" onclick="return confirm('Yakin Akan Hapus Data ?')">Hapus</a>
                                    </td>
                                	</tr>
                                	<?php
                                }
