...
class Mpt extends CI_Controller{
	public function index(){
		...
		//uptd model
		$this->load->model("MptModel");
		$viewAll=$this->MptModel->viewAll(@$_GET["prov"],@$_GET["kab"],@$_GET["kec"],@$_GET["desa"],@$_GET["tahun"]);
		$data["viewData"] = $viewAll;
				
		$this->load->view('templates/header');
		$this->load->view("mpt/index",$data);
	...
	public function form_tambah()
	{
		...
		$this->load->view('templates/header');
		$this->load->view('mpt/form_tambah',$data);
		$this->load->view('templates/footer');
	}
	public function tambah(){	
		$this->load->model('MptModel');
		$this->MptModel->tambah();
		Mpt::index();
	}
	...
	public function form_edit($id){
		...
		$this->load->model('MptModel');				
		$data['viewData'] = $this->MptModel->getData($id);
		$this->load->view('templates/header');
		$this->load->view('mpt/form_edit',$data);
		$this->load->view('templates/footer');
	}
